...
- Função `prompt()`
  - [Docs deno](https://docs.deno.com/examples/prompts/)
  - [Docs MDN (Mozzila Developer Network)](https://developer.mozilla.org/en-US/docs/Web/API/Window/prompt)
- Função `Number()` 
  - [Docs MDN](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number)
